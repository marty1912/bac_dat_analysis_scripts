...
cols=c("ies.1.FALSE.single",  "ies.2.FALSE.single"))
res
...
x_labels_to_use = c("1","2"),
    x_lab= "Distanz",
    y_lab= "Reaktionszeit in s", 
cols=c("ies.1.FALSE.dual_phon",  "ies.2.FALSE.dual_phon"))
...
cols=c("ies.1.FALSE.dual_vis",  "ies.2.FALSE.dual_vis"))
...
x_labels_to_use = c("1","2"),
    x_lab= "Distanz", y_lab= "Reaktionszeit in s",
cols=c("ies.1.FALSE.dual_rig",  "ies.2.FALSE.dual_rig"))
...
x_labels_to_use = c("1","2"),
    x_lab= "Distanz", y_lab= "Reaktionszeit in s",
cols=c("ies.1.TRUE.single",  "ies.2.TRUE.single"))
...
x_labels_to_use = c("1","2"),
    x_lab= "Distanz", y_lab= "Reaktionszeit in s",
cols=c("ies.1.TRUE.dual_phon",  "ies.2.TRUE.dual_phon"))
...
x_labels_to_use = c("1","2"),
    x_lab= "Distanz", y_lab= "Reaktionszeit in s",
cols=c("ies.1.TRUE.dual_vis",  "ies.2.TRUE.dual_vis"))
...
x_labels_to_use = c("1","2"),
    x_lab= "Distanz", y_lab= "Reaktionszeit in s",
cols=c("ies.1.TRUE.dual_rig",  "ies.2.TRUE.dual_rig"))
```
...
## single vs. phon 
 ...
 ```{r}
t_test_and_plot(dat,
x_labels_to_use = c("dual phon","single"),
...
## single vs. vis
 ...
 ```{r}
t_test_and_plot(dat,
x_labels_to_use = c("dual vis","single"),
    x_lab= "Bedingung", y_lab= "distance effect",
cols=c("dist_effect.FALSE.single",  "dist_effect.FALSE.dual_vis"))
```
...
t_test_and_plot(dat,
x_labels_to_use = c("dual rig","single"),
    x_lab= "Bedingung", y_lab= "distance effect",
...
cols=c("rev_dist_effect.TRUE.single",  "rev_dist_effect.TRUE.dual_phon"))
```
...
x_labels_to_use = c("dual vis","single"),
    x_lab= "Bedingung", y_lab= "reverse distance effect",
cols=c("rev_dist_effect.TRUE.single",  "rev_dist_effect.TRUE.dual_vis"))
```
...
x_labels_to_use = c("dual rig","single"),
    x_lab= "Bedingung", y_lab= "reverse distance effect",
cols=c("rev_dist_effect.TRUE.single",  "rev_dist_effect.TRUE.dual_rig"))
